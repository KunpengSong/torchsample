# Source: https://github.com/warmspringwinds/pytorch-segmentation-detection/blob/master/pytorch_segmentation_detection/models/resnet_dilated.py
# Does not work because it uses a customized version of pytorch/vision
