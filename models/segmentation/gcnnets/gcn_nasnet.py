...
class GCN_NASNET(nn.Module):
    def __init__(self, num_classes, input_size, k=7):
        ...
        state_dict = torch.utils.model_zoo.load_url('http://data.lip6.fr/cadene/pretrainedmodels/nasnetalarge-a1897284.pth')

        self.nasnet = NASNetALarge()
        self.nasnet.load_state_dict(torch.load(state_dict))
