...
class ResNeXt(nn.Module):
    ...
    def __init__(self):
        ...
        state_dict = torch.utils.model_zoo.load_url('http://data.lip6.fr/cadene/pretrainedmodels/resnext101_64x4d-e77a0586.pth')
        self.resnext = self.get_resnext()
        self.resnext.load_state_dict(state_dict)
    ...
    def get_resnext(self):
        resnext_module = nn.Sequential(  # Sequential,
