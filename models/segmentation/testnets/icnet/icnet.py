# Source: https://github.com/adam9500370/pytorch-semseg/blob/master/ptsemseg/models/icnet.py (MIT)
...
class icnet(nn.Module):
    ...
    def __init__(
        ...
        self.n_classes = (
            icnet_specs[version]["num_classes"] if version is not None else num_classes
        )
        self.input_size = (
