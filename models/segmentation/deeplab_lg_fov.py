# Source:  https://github.com/BardOfCodes/pytorch_deeplab_large_fov

import torch.nn as nn
import torch.nn.functional as F


class Deeplab_LG_FOV(nn.Module):
    def __init__(self, num_classes=1):
        super(Deeplab_LG_FOV, self).__init__()
        ...
        self.fc8_voc12 = nn.Conv2d(1024, num_classes, 1)
