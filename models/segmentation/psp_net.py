...
class PSPNet(nn.Module):
    def __init__(self, num_classes, pretrained=True, use_aux=True, model='resnet101'):
        ...
        if pretrained:
            if model == 'resnet152':
                ...
                if os.path.exists(res101_path):
                    ...
                    state_dict = torch.utils.model_zoo.load_url(model_urls['resnet101'])
