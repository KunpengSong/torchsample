...
class UNet_Elu(nn.Module):
    ...
    Attributes:
        ...
        filter_base and depth are connected as filter_base*2**depth = 1024 - the number of channels on the bottom layer
    """
    ...
    def __init__(self,
        ...
        # input layer
        self.input_layer = nn.Sequential(Conv3BN(input_channels, filters_base), Conv3BN(filters_base, filters_base), )
        # Going down:

        self.down1 = UNetEncoder(32, 64)
        self.down2 = UNetEncoder(64, 128)
        self.down3 = UNetEncoder(128, 256)
        self.down4 = UNetEncoder(256, 512)
        self.down5 = UNetEncoder(512, 1024)
        """
        ...
        """
        # Going up:
        self.up1 = UNetDecoder(1536, 512)
        self.up2 = UNetDecoder(768, 256)
        self.up3 = UNetDecoder(384, 128)
        self.up4 = UNetDecoder(192, 64)
        self.up5 = UNetDecoder(96, 32)
        """
