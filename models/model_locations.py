...
model_urls = {
    ...
    'densenet121': torchroot + 'densenet121-241335ed.pth',
    'densenet169': torchroot + 'densenet169-6f0f7f60.pth',
    'densenet201': torchroot + 'densenet201-4c113574.pth',
    'densenet161': torchroot + 'densenet161-17b70270.pth',
    'dpn68': dpnroot + 'dpn68-66bebafa7.pth',
    'dpn68b-extra': dpnroot + 'dpn68b_extra-84854c156.pth',
    'dpn92-extra': dpnroot + 'dpn92_extra-b040e4a9b.pth',
    'dpn98': dpnroot + 'dpn98-5b90dec4d.pth',
    'dpn107-extra': dpnroot + 'dpn107_extra-1ac7121e2.pth',
    'dpn131': dpnroot + 'dpn131-71dfe43e0.pth',
    ...
    'bninception': cadeneroot + 'bn_inception-239d2248.pth',
    ...
    'xception': cadeneroot + 'xception-b5690688.pth'
}